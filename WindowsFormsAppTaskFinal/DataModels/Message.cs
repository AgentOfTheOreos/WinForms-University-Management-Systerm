...
namespace WindowsFormsAppTaskFinal.DataModels
{
    ...
    public class Message
    {
        ...
        // Constructor
        public Message(string sender, string receiver, string title, string content, DateTime date, bool bookmarkStatus)
        {
            Sender = sender;
            Receiver = receiver;
            Title = title;
        ...
        public override bool Equals(object obj)
        {
            if (obj is Message other)
            {
                return Sender.Equals(other.Sender) &&
                       ...
                       BookmarkStatus.Equals(other.BookmarkStatus);
            }
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                ...
                hash = hash * 23 + BookmarkStatus.GetHashCode();
;               return hash;
            }
        }
